...
const ProductDetail = ({ product }) => {
    ...
    return (
        <>
            ...
            <Typography style={{ marginTop: 5, color: '#878787', fontSize: 20 }}>
                8 Ratings & 1 Reviews
                <Box component='span'><img src={fassured} style={{ width: 80, marginLeft: 20 }} alt='fliplogo' /></Box>
            </Typography>
            <Typography>
                <Box component='span' style={{ fontSize: 30 }}> ₹{product.price.cost}</Box>&nbsp;&nbsp;&nbsp;
                <Box component='span' style={{ color: 'lightslategray', fontSize: 20 }}> ₹<strike>{product.price.mrp}</strike></Box>
                <Box component='span' style={{ color: 'lightgreen' }}>{product.price.discount}</Box>
            </Typography>
            ...
            <Box>
                ...
                <Table>
                    <TableBody>
                        ...
                        <TableRow>
                            <TableCell colSpan={2}>
                                <img src={adURL} style={{ width: 390 }} alt='advertise' />
                            </TableCell>
                        </TableRow>
                        <ColumnText>
